...
public class OXOMoveException extends Exception {
  ...
  public static class InvalidIdentifierLengthException
    extends OXOMoveException {
  ...
  public static class InvalidIdentifierCharacterException
    extends OXOMoveException {

    private static final long serialVersionUID = 3292975112861815343L;

    public InvalidIdentifierCharacterException(
      RowOrColumn problemDimension,
      char character
    ) {
      super(
        character + " is not a valid character for a " + problemDimension.name()
      );
    }
  }
